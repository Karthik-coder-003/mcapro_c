//A  C program to implement the Bank management system cocded by KARTHIKEYAN G
#include <stdio.h>
#include <stdlib.h>
#include <windows.h>
#include <malloc.h>
...
// Declaring gotoxy function to manage cursor
...
void checkbalance(char username2[])
{
	...
	// Reading username to fetch the correct account details
